...
[**FileList**](files.md) **>** [**tests**](dir_59425e443f801f1f2fd8bbe4959a3ccf.md) **>** [**isotp\_test\_support.h**](isotp__test__support_8h.md)
...
| Type | Name |
| ---: | :--- |
|  void | [**reset\_mocks**](#function-reset_mocks) () <br>_Reset all mock state to initial values, should be called before each test._  |
...
_Reset all mock state to initial values, should be called before each test._ 
```C++
void reset_mocks () 
```
